...
void Scene_Shop::Start() {
	shop_window.reset(new Window_Shop(0, (Metrics::Display::OriginalWidth()/2), Metrics::Display::OriginalWidth(), 80));
	help_window.reset(new Window_Help(0, 0, Metrics::Display::OriginalWidth(), 32));
	gold_window.reset(new Window_Gold(184, 128, 136, 32));
	empty_window.reset(new Window_Base(0, 32, Metrics::Display::OriginalWidth(), 128));
	...
	sell_window.reset(new Window_ShopSell(0, 32, Metrics::Display::OriginalWidth(), 128));
