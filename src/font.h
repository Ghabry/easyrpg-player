...
class Font {
 public:
	 ...
	 */
	std::vector<ShapeRet> Shape(U32StringView text, Text::Direction direction) const;
	...
	virtual std::vector<ShapeRet> vShape(U32StringView, Text::Direction) const { return {}; }
